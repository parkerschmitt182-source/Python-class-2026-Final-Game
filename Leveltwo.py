...
church = pygame.image.load("hosts.png")
...
tilemap = [
    'B_______B___E___B__BBB________________________________BB_____________________________F_____',
    'B_______________B______________________________________B________________________BBBBB_______',
    'B_______B_______B____BBBBBBBBBBB_____________BBBB___________________________BBBB____________',
    'B_______________B____________________BBBBB________________B____E_____BBBBB_____BBBB___________',
    'B_______________B______________________________BBB_____________________________B____BBBB_____',
    'BBBBBBBBBBBBBBBBBBBBBBB__________________BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB'
            ]
blocks = []
tileSize = 100
enimys = []
